...
class Net(nn.Module):
    ...
    def augtask_loss(self, content, mask):

        content = F.interpolate(content, mask.shape[2:], mode='bilinear', align_corners=True)
        augtask_loss = F.binary_cross_entropy_with_logits(content, mask, reduction='mean')
    ...
    def forward(self, content, style, alpha=1.0):
        ...
        # print("------------------")
        # print(g_t.shape)
        # print(g_t_feats[-1].shape) #torch.Size([1, 512, 48, 48])
